...
for j = 1:S
    ...
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{1},'_run-0',num2str(j),'_onsets.mat');
    save(filename, 'names', 'onsets', 'durations', 'pmod', 'orth');
    
    % base with orthogonalization
    orth_orig = orth;
    orth = num2cell(true(size(names)));
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{2},'_run-0',num2str(j),'_onsets.mat');
    save(filename, 'names', 'onsets', 'durations', 'pmod', 'orth');
    ...
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{3},'_run-0',num2str(j),'_onsets.mat');
    save(filename, 'names', 'onsets', 'durations', 'pmod', 'orth');
    
    % base with own design matrix
    pmod = pmod_orig;
    [R, L] = create_design_matrix(names, onsets, durations, pmod, [], RP, settings);
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{4},'_run-0',num2str(j),'_matrix.mat');
    save(filename, 'R');
    ...
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{5},'_run-0',num2str(j),'_onsets.mat');
    save(filename, 'names', 'onsets', 'durations', 'pmod', 'orth');
    ...
    orth = num2cell(true(size(names)));
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{6},'_run-0',num2str(j),'_onsets.mat');
    save(filename, 'names', 'onsets', 'durations', 'pmod', 'orth');
...
for j = 1:S
    ...
    pmod = pmod_temp;
    [R, L] = create_design_matrix(names, onsets, durations, pmod, [], RP, settings);
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{C+1},'_run-0',num2str(j),'_matrix.mat');
    save(filename, 'R');
    ...
    pmod(1).param = []; 
    [R, L] = create_design_matrix(names, onsets, durations, pmod, [], RP, settings);
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{C+2},'_run-0',num2str(j),'_matrix.mat');
    save(filename, 'R');
    ...
    for i = 1:C
        ...
        [R, L] = create_design_matrix(names, onsets, durations, pmod, [], RP, settings);
        filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{i},'_run-0',num2str(j),'_matrix.mat');
        save(filename, 'R');
    end;
...
for j = 1:S
    ...
    pmod = pmod_temp;
    [R, L] = create_design_matrix(names, onsets, durations, pmod, [], RP, settings);
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{1},'_run-0',num2str(j),'_matrix.mat');
    save(filename, 'R');
    ...
    pmod = [];
    [R, L] = create_design_matrix(names, onsets, durations, pmod, [], RP, settings);
    filename = strcat(work_dir,'/','sub-',subj_id,'/anal/','glms-',MS_name,'/','sub-',subj_id,'_glm-',GLM_names{2},'_run-0',num2str(j),'_matrix.mat');
    save(filename, 'R');
