function ITEM_dec_recon_LS_A_SVR(SPM, ROI, c, con, reg)
% _
% Decoding from Trials for Reconstruction (***least squares, all [SVR]***)
...
%  Last edit: 02/04/2019, 14:50 (Vn/a)
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','ITEM_dec_recon_LS_A_SVR: load');
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','ITEM_dec_recon_LS_A_SVR: estimate (1)');
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','ITEM_dec_recon_LS_A_SVR: estimate (2)');
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','ITEM_dec_recon_LS_A_SVR: save');

% Create target directory
%-------------------------------------------------------------------------%
ITEM.swd = strcat(SPM.swd,'/','ITEM_dec_recon_LS_A_SVR','/');
