function ITEM_dec_recon_LS_S(SPM, ROI, c, con, reg)
% _
% Decoding from Trials for Reconstruction (***least squares, separate***)
...
%  Last edit: 19/02/2019, 12:55 (Vn/a)
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','ITEM_dec_recon_LS_S: load');
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','ITEM_dec_recon_LS_S: estimate (1)');
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','ITEM_dec_recon_LS_S: estimate (2)');
...
% Init progress bar
%-------------------------------------------------------------------------%
Finter = spm('FigName','ITEM_dec_recon_LS_S: save');

% Create target directory
%-------------------------------------------------------------------------%
ITEM.swd = strcat(SPM.swd,'/','ITEM_dec_recon_LS_S','/');
